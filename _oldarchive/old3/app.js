...
const app = createApp({
    components: {
        ...
        'parsing-tab': window.parsingTabComponent,
        'videos-tab': window.videosTabComponent,
        'channels-tab': window.channelsTabComponent,
        'tasks-tab': window.tasksTabComponent,
        'analytics-tab': window.analyticsTabComponent,
        'settings-tab': window.settingsTabComponent,
        'help-tab': window.helpTabComponent,
        'video-modal': window.videoModalComponent,
        'channel-modal': window.channelModalComponent,
        'notification-toast': window.notificationToastComponent
    },
    data() {
        return {
            // Navigation
            ...
            // ... остальной код data() без изменений
